...
public class MainActivity extends BaseActivity {
    ...
    private boolean isNavigatingMain = true;//MainActivity中显示的三个页面
    ...
    @Override public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action.equals(Constants.NAVIGATE_ALBUM) || action.equals(Constants.NAVIGATE_ARTIST)
                || action.equals(Constants.NAVIGATE_NOWPLAYING))
        {
...
/*----------- 在setContentView之前设置主题  ------------*/
        ...
        } else
        {
                    ...
                    Manifest.permission.READ_EXTERNAL_STORAGE))
            {
                Snackbar.make(panelLayout,
                        "Timber will need to read external storage to display songs on your device.",
            ...
            {
                Nammu.askForPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE,
                        permissionReadstorageCallback);
            }
        }
    }
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            case android.R.id.home:
                if (!(action.equals(Constants.NAVIGATE_ALBUM) || action.equals(
                        Constants.NAVIGATE_ARTIST) || action.equals(Constants.NAVIGATE_NOWPLAYING)))
                {
    ...
    private void setupNavigationIcons(NavigationView navigationView)
    {
        ...
        if (isLightTheme)
        {
            ...
            navigationView.getMenu()
                    .findItem(R.id.nav_nowplaying)
                    .setIcon(R.drawable.bookmark_music);
        ...
        {
            navigationView.getMenu()
                    .findItem(R.id.nav_library)
                    .setIcon(R.drawable.library_music_white);
            navigationView.getMenu()
                    .findItem(R.id.nav_playlists)
                    .setIcon(R.drawable.playlist_play_white);
            navigationView.getMenu().findItem(R.id.nav_queue).setIcon(R.drawable.music_note_white);
            navigationView.getMenu()
                    .findItem(R.id.nav_nowplaying)
                    .setIcon(R.drawable.bookmark_music_white);
    ...
    private void updatePosition(final MenuItem menuItem)
    {
        ...
        switch (menuItem.getItemId())
        {
            case R.id.nav_library:
                ...
                {
                    NavigationUtils.navigateToMainActivityWithFragment(MainActivity.this,
    ...
    @Override public void onMetaChanged()
    {
        super.onMetaChanged();
        setDetailsToHeader();
    }
    ...
    Runnable navigateNowplaying = new Runnable() {
        public void run()
        {
            ...
            SharedPreferences prefs      =
                    getSharedPreferences(Constants.FRAGMENT_ID, Context.MODE_PRIVATE);
            String            fragmentID =
                    prefs.getString(Constants.NOWPLAYING_FRAGMENT_ID, Constants.TIMBER3);

            Fragment        fragment        =
                    NavigationUtils.getFragmentForNowplayingID(fragmentID);
            FragmentManager fragmentManager = getSupportFragmentManager();
    ...
    private class initQuickControls extends AsyncTask<String, Void, String> {
        ...
        @Override protected String doInBackground(String... params)
        {
            ...
            fragmentManager1.beginTransaction()
                    .replace(R.id.quickcontrols_container, fragment1)
                    .commitAllowingStateLoss();
            return "Executed";
        }
